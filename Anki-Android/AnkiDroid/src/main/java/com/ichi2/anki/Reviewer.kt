...
open class Reviewer :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // "Progress" shortcut in the top bar, next to the card counts, opening the Concept Scheduler.
        findViewById<View>(R.id.concept_scheduler_progress).setOnClickListener {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.action_concept_scheduler_status -> {
    ...
    /**
     * Opens the Concept Scheduler status as a bottom sheet over the reviewer, so studying continues
     * underneath. The sheet reads the backend read model for the currently selected deck.
     */
    private fun openConceptSchedulerStatus() {
        launchCatchingTask {
            val deckId = withCol { decks.selected() }
            ConceptSchedulerStatusBottomSheet
                .newInstance(deckId)
