...
pub struct NormalDeckSchema11 {
    ...
    concept_scheduler_enabled: bool,
}
...
impl Default for NormalDeckSchema11 {
    fn default() -> Self {
        NormalDeckSchema11 {
            ...
            concept_scheduler_enabled: false,
        }
    }
}
...
impl From<NormalDeckSchema11> for NormalDeck {
    fn from(deck: NormalDeckSchema11) -> Self {
        NormalDeck {
            ...
            concept_scheduler_enabled: deck.concept_scheduler_enabled,
        }
    }
}
    ...
    fn from(deck: Deck) -> Self {
        match deck.kind {
            DeckKind::Normal(ref norm) => DeckSchema11::Normal(NormalDeckSchema11 {
                ...
                concept_scheduler_enabled: norm.concept_scheduler_enabled,
                common: deck.into(),
            }),
