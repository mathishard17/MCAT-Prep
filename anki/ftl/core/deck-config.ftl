...
deck-config-concept-scheduler = Concept Scheduler
deck-config-concept-scheduler-mode = Concept Scheduler Mode
deck-config-concept-scheduler-mode-tooltip =
    When enabled, Anki can use Knowledge Component tags such as `KC::Bio::DNA`
    and `Prereq::Bio::DNA` to choose better new MCAT concepts. Reviews still
    use Anki's normal scheduling.
deck-config-concept-scheduler-status-on =
    Concept Scheduler is on for { $deck }. Tagged new cards use topic readiness and focused blocks.
deck-config-concept-scheduler-status-off =
    Concept Scheduler is off for this deck. Anki will keep using the normal new-card order.
deck-config-concept-scheduler-learning-boundary =
    Topic readiness
deck-config-concept-scheduler-learning-boundary-tooltip =
    Topics are grouped by what is already ready, what is a good next step, and what is waiting on prerequisites.
deck-config-concept-scheduler-inner-fringe =
    Ready foundations
deck-config-concept-scheduler-outer-fringe =
    Recommended next
deck-config-concept-scheduler-locked-topics =
    Waiting on prerequisites
deck-config-concept-scheduler-graph-sample =
    Sample layout only. Live mastery and topic recommendations will appear in the reviewer once the status RPC and topic picker are wired.
deck-config-concept-scheduler-graph-live =
    Topic map. Lines point from prerequisites to dependent topics.
deck-config-concept-scheduler-seen-cards =
    Review history
deck-config-concept-scheduler-positive-today =
    Correct today
deck-config-concept-scheduler-prereq-violations =
    Advanced before prerequisites
deck-config-concept-scheduler-evidence-progress =
    { $seen } of { $required } tagged cards reviewed
deck-config-concept-scheduler-mastery =
    Mastery: { $percent }
deck-config-concept-scheduler-readiness =
    Readiness: { $percent }
deck-config-concept-scheduler-cards-reviewed =
    { $count ->
        [one] { $count } card reviewed
       *[other] { $count } cards reviewed
    }
deck-config-concept-scheduler-correct-incorrect =
    { $correct } correct, { $incorrect } incorrect
deck-config-concept-scheduler-topic-map =
    Topic map
deck-config-concept-scheduler-graph-aria =
    Concept Scheduler topic map
deck-config-concept-scheduler-graph-legend-ready =
    Ready
deck-config-concept-scheduler-graph-legend-next =
    Next
deck-config-concept-scheduler-graph-legend-locked =
    Waiting
deck-config-concept-scheduler-loading =
