...
<script lang="ts">
    ...
    import ConceptSchedulerOptions from "./ConceptSchedulerOptions.svelte";
    ...
    export const conceptSchedulerOptions = {};
...
<div class="deck-options-page">
    ...
    >
        <div>
            ...
            <Row class="row-columns">
                <ConceptSchedulerOptions {state} api={conceptSchedulerOptions} />
            </Row>
